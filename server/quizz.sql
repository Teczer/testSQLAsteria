...
VALUES
    (
        ...
        'Rocheuse et gazeuze',
        'Notre système solaire contient les deux types de planètes. Mercure, Vénus, la Terre et Mars sont des planètes rocheuses aussi appelées "planètes telluriques", alors que Jupiter, Saturne, Uranus et Neptune sont des planètes gazeuses.'
    );
...
VALUES
    (
        ...
        'https://res.cloudinary.com/dw3mwclgk/image/upload/v1670677936/images-quizz/SystemeSolaireQuizz/quizz-1-answer-6_sudkjm.jpg',
        '2006',
        'Pluton a été reclassée en tant que planète naine en 2006 lors de la réunion de l''Union Astronomique Internationale.'
    );
